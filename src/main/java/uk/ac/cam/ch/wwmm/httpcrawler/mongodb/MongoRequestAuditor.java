...
public class MongoRequestAuditor implements RequestAuditor {
    ...
    public void auditResponse(final long timestamp, final HttpRequest request, final HttpResponse response, final HttpContext context) {

        final DBObject o = new BasicDBObject();
        recordRequest(timestamp, request, context, o);
    ...
    public void auditError(final long timestamp, final HttpRequest request, final Throwable error, final HttpContext context) {
        final DBObject o = new BasicDBObject();
        recordRequest(timestamp, request, context, o);
    ...
    private void recordRequest(final long timestamp, final HttpRequest request, final HttpContext context, final DBObject o) {
